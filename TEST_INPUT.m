...
%VEHICLE GEOMETRY     %
%%%%%%%%%%%%%%%%%%%%%%%
geometry.Wing.Sref              = 150   *ftsq2msq;
geometry.Wing.AR                = 12;
...
geometry.Fuse.Swet               = 300  * ftsq2msq;
...
%VEHICLE WEIGHTS%
%%%%%%%%%%%%%%%%%
weights.MTOW        = 4000    * lbf2N;
weights.payload     = 4*195     * lbf2N;
...
%PROPULSION SYSTEM%
%%%%%%%%%%%%%%%%%%%
propulsion.P_shaft_max  = 250e3;        %W
propulsion.eta_p_TO     = .85;
propulsion.eta_p_rev    = .3;
propulsion.n_prop       = 8;
propulsion.D_prop       = 3 *ft2m;  
